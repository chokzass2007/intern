                                ...
                                <div class="row g-0">
                                    <div class="col-6">
                                        <span class=" lh-1 mb-1">
                                            {{ Carbon::parse($profileData->start_intern)->thaidate('D j M y') }}</span><small
                                            class="badge rounded badge-soft-danger false">
            ...
            <div class="col-xxl-7">
                <div class="card h-100 font-sans-serif">
                    ...
                    <h3 class="fw-light overflow-hidden font-sans-serif text-center">
                        ...
                        <form class="mt-3" action="{{ route('' . $profileData->role . '.update.password') }}" method="POST">
                            @csrf
                            <div class="mb-3 row">
                                <label class="col-sm-3 mt-3 col-form-label text-start" for="staticEmail">รหัสผ่านเก่า
                                    :</label>
                                ...
                                <label class="col-sm-3 mt-3 col-form-label text-start" for="staticEmail">รหัสผ่านใหม่
                                    :</label>
                                <div class="col-sm-9 mt-3">
                                ...
                                <label class="col-sm-3 mt-3 col-form-label text-start" for="staticEmail">ยืนยันรหัสผ่านใหม่
                                    :</label>
                                <div class="col-sm-9 mt-3">
