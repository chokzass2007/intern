                ...
                <div class="card h-100 font-sans-serif">
                    <div class="card-body">
                        <h3 class="fw-light overflow-hidden font-sans-serif text-center">
                            <span style="color: #2c7be5" class="typed-text fw-bold ms-1 ">แก้ไขโปรไฟล์นักศึกษา</span>
                        </h3>
                        <form action="{{ route('' . $profileData->role . '.update.profile') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label text-start" for="staticEmail">รหัสนักศึกษา :</label>
                                <div class="col-sm-9">
                                    <input class="form-control-plaintext mt-2" id="staticEmail" type="text"
                                        name="idStudent" readonly value="{{ $profileData->idStudent }}" />
                                </div>
                                {{--  --}}
